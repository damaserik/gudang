...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-2 col-sm-3">
      <a href="<?php echo site_url('gudang/nota/view_nota');?>"><button type="button" class="btn btn-dark btn-block">Kembali</button></a>
    </div>
  </div>
  <br>
  <div class="row">
              ...
              <tr>
                  ...
                  <td class="project-actions text-center">
                     <?php if($this->session->userdata('hak_akses') == "Admin" || $this->session->userdata('hak_akses') == "Super Admin"){ ?>
                      <a href="<?php echo site_url('gudang/nota/edit_notadtl/'.$row->id_dtl)?>"><i class="fas fa-pencil-alt fa-sm"></i></a>
                      <a href="<?php echo site_url('gudang/nota/dtl_nota_hapus/'.$row->id_dtl)?>" onclick="return confirm('Konfirmasi Hapus Data ?')"><i class="fas fa-trash fa-sm"></i></a> <?php } ?> </td>
              </tr>
              <?php } ?>
      </table>
    </div>
